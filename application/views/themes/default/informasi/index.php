                            ...
                            <div class="column one column_blog">
                                <div class="blog_wrapper isotope_wrapper">
                                    <?php
                                        ...
                                        $_query = $this->vw_informasi_m->get_limit(array('is_publish' => '1'), $limit, $limit_start);
                                        if (count($_query) > 0) {
                                            # code...
                                            ...
                                            <div class="post-desc-wrapper">
                                                <div class="post-desc">
                                                    ...
                                                    <div class="post-title">
                                                        <h2 class="entry-title"><a href="<?php echo base_url('view/informasi/'.$value->page_id) ?>"><?php echo $this->limit_text($value->judul, 35) ?></a></h2>
                                                    </div>
                                                    <div class="post-excerpt">
                                                        <span class="big"><?php echo $this->limit_text($value->content, 160) ?></span>
                                                    </div>
                                                    <a class="mfn-link mfn-link-4" href="<?php echo base_url('view/informasi/'.$value->page_id) ?>" data-hover="Phasellus" style="margin: 0"><span data-hover="Phasellus">Selengkapnya</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="column one pager_wrapper">
                                        ...
                                        <div class="pager">
                                            ...
                                            ?>
                                                    <a href="<?php echo base_url('informasi/'.$link_prev); ?>">
                                            ...
                                            <div class="pages">
                                                <?php  
                                                    $get_jumlah = count($this->vw_informasi_m->get());
                                                ...
                                                ?>
                                                        <a href="<?php echo base_url('informasi/'.$i) ?>"<?php echo $link_active ?>><?php echo $i ?></a>
                                                <?php
                                                    }
                                                ?>
                                            </div>
                                            ...
                                            ?>
                                                    <a class="next_page" href="<?php echo base_url('informasi/'.$link_next); ?>">
                        ...
                        <aside class="widget widget_mfn_recent_posts">
                            ...
                            <div class="Recent_posts">
                                ...
                                <ul>
                                    ...
                                    ?>
                                    <li class="post ">
                                        <a href="<?php echo base_url('view/informasi/'.$value->page_id) ?>" title="<?php echo $value->judul ?>">
