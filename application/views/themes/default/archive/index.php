                            ...
                            <div class="column one column_blog">
                                <div class="blog_wrapper isotope_wrapper">
                                    <?php
                                        ...
                                        $_query = $this->vw_berita_m->get_limit($where, $limit, $limit_start);
                                        if (count($_query) > 0) {
                                            # code...
                                        ...
                                        <div class="post-175 post  format-standard has-post-thumbnail  category-motion category-photography category-uncategorized tag-eclipse tag-grid tag-mysql post-item isotope-item clearfix">
                                            ...
                                            <div class="post-desc-wrapper">
                                                <div class="post-desc">
                                                    ...
                                                    <a class="mfn-link mfn-link-4" href="#" data-hover="Phasellus" style="margin: 0"><span data-hover="Phasellus">Selengkapnya</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                        ...
                                        $get_jumlah = count($this->vw_berita_m->get_by($where));
                                    ...
                                    <div class="column one pager_wrapper">
                                        ...
                                        <div class="pager">
                                            ...
                                            <div class="pages">
                                                ...
                                                ?>
                                                        <a href="<?php echo base_url('archive/'.$month.'/'.$year.'/'.$i) ?>"<?php echo $link_active ?>><?php echo $i ?></a>
                                                <?php
                                                    }
                                                ?>
                                            </div>
