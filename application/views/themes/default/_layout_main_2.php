...
<?php 
    if ($this->router->fetch_class() == 'beranda') {
        # code...
        $css = 'page-parent template-slider color-blue layout-full-width header-transparent sticky-header sticky-white subheader-title-left';
        $nav_bar = $sidebar;
    } else {
...
<body class="<?php echo $css ?>">
                ...
                <div class="container">
                    ...
                    <div class="column one-second">
                        ...
                        <aside id="text-7" class="widget widget_text">
                            <div class="textwidget"><img src="<?php echo $base_assets_url?>images/logo_footer.png" alt="" width="130" height="30" />
                                <p>
                                    ...
                                    <ul>
                                        <li>
                                            <p style="padding-top: 10px">
                                                <i class="icon-location-line"></i> Jl.raya raden inten No.35, Banding Agung, Talang Padang, Kabupaten Tanggamus, Lampung 35377
                                            </p>
                                        </li>
                                        <li>
                                            <p style="padding-top: 10px">
                                                <i class="icon-phone"></i>(0729) 41270
                                            </p>
                                        </li>
                                        <li>
                                            <p style="padding-top: 10px">
            ...
            <div class="footer_copy">
                <div class="container">
                    <div class="column one">
                        ...
                        <div class="copyright">
                            &copy; 2017 Tracerstudy - SMK N 1 Talang Padang
                        </div>
                        <!--Social info area-->
                        <ul class="social">
                            <li class="facebook">
    ...
    <script src="<?php echo $base_assets_url?>plugins/chartists/chartist-plugin-legend.js"></script>
