                                    ...
                                    <div class="dropdown-menu animated flipInY user-profile">
                                        ...
                                        <div class="m-t-10 p-3 drop-list">
                                            <ul class="list-unstyled">
                                                <li><a href="<?php echo base_url('instansi/profile') ?>"><i class="icon-user"></i>My Profile</a></li>
                                                <li><a href="#defaultModal" data-toggle="modal" data-target="#defaultModal"><i class="icon-settings"></i>Settings</a></li>
                                                <li class="divider"></li>
            ...
            <nav id="leftsidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li <?php echo $active = ($this->router->fetch_class() == 'dashboard') ? 'class="active"' : null ; ?>>
                        <a href="<?php echo base_url('instansi') ?>"><i class="icon-home"></i><span>Dashboard</span></a>
                    </li>
                
                    <li class="heading">Alumni</li>
                    
                    <li  <?php echo $active = ($this->router->fetch_class() == 'alumni') ? 'class="active"' : null ; ?>>
                        <a href="<?php echo base_url('instansi/alumni') ?>"><i class="icon-graduation"></i><span>Daftar Alumni</span></a>
                    </li>                    
                    <li  <?php echo $active = ($this->router->fetch_class() == 'kegiatan') ? 'class="active"' : null ; ?>>
                        <a href="<?php echo base_url('instansi/kegiatan') ?>"><i class="icon-graduation"></i><span>Kegiatan</span></a>
                    </li>
                
                    <li class="heading">Instansi</li>

                    <li <?php echo $active = ($this->router->fetch_class() == 'penilaian' && $breadcrumb != 'Daftar Penilaian Instansi') ? 'class="active"' : null ; ?>>
                        <a href="<?php echo base_url('instansi/penilaian') ?>"><i class="icon-bag"></i><span>Penilaian</span></a>
                    </li>
                
                    <li class="heading">Hasil Survey</li>

                    <li <?php echo $active = ($this->router->fetch_class() == 'kebutuhan') ? 'class="active"' : null ; ?>>
                        <a href="<?php echo base_url('instansi/kebutuhan') ?>"><i class="icon-hourglass"></i><span>Kebutuhan</span></a>
                    </li>
                    <li <?php echo $active = ($this->router->fetch_class() == 'kesesuaian') ? 'class="active"' : null ; ?>>
                        <a href="<?php echo base_url('instansi/kesesuaian') ?>"><i class="icon-bar-chart"></i><span>Kesesuaian</span></a>
                    </li>
                    <li <?php echo $active = ($this->router->fetch_class() == 'penilaian' && $breadcrumb == 'Daftar Penilaian Instansi') ? 'class="active"' : null ; ?>>
                        <a href="<?php echo base_url('instansi/penilaian/daftar-penilaian') ?>"><i class="fa fa-bank"></i><span>Penilaian Instansi </span></a>
                    </li>
                </ul>
            </nav>
        </div>
