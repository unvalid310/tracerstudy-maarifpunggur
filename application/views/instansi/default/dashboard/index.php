            <div class="row clearfix">
                <div class="col-12">
                    ...
                    <div class="alert alert-info alert-dismissible p-t-15" role="alert">
                        ...
                        <p class="p-t-15">
                            Jika anda ingin melakukan update data penilaian anda dapat mengakses 
                            <a href="<?php echo base_url('instansi/penilaian') ?>" title="Ulangi kuesioner">disini</a>
                        </p>
                    </div>
                    <?php
                        } else {
                    ...
                    <div class="alert alert-danger alert-dismissible p-t-15" role="alert">
                        <h3><strong>Selamat datang, <?php echo $this->session->userdata('realname'); ?></strong></h3>
                        <p class="p-t-15">
                            Segera lakukan pengisian survey untuk proses penilaian 
                            <a href="<?php echo base_url('instansi/penilaian') ?>" title="Ulangi kuesioner">disini</a>
                        </p>
                    </div>
                    <?php
