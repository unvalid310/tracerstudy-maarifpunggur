            <div class="row clearfix">
                <div class="col-12">
                    <?php  
                        if ($this->session->userdata('is_complete') == 1) {
                            # code...
                    ?>
                    <div class="alert alert-info alert-dismissible p-t-15" role="alert">
                        <h3><strong>Selamat datang, <?php echo $this->session->userdata('realname'); ?></strong></h3>
                        <p class="p-t-15">
                            Jika anda ingin melakukan update data kuesioner anda dapat mengakses 
                            <a href="<?php echo base_url('alumni/kuesioner') ?>" title="Ulangi kuesioner">disini</a>
                        </p>
                    </div>
                    <?php
                        } else {
                    ?>
                    <div class="alert alert-danger alert-dismissible p-t-15" role="alert">
                        <h3><strong>Selamat datang, <?php echo $this->session->userdata('realname'); ?></strong></h3>
                        <p class="p-t-15">
                            Segera lakukan pengisian survey untuk proses pendataan alumni  
                            <a href="<?php echo base_url('alumni/kuesioner') ?>" title="Ulangi kuesioner">disini</a>
                        </p>
                    </div>
                    <?php
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="body">
                                    ...
                                    <small class="text-muted">
                                        <strong><?php echo $_user_percent.'%' ?></strong> sudah mengisi survey
                                    </small>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6">
