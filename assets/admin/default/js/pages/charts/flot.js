...
$(function() {
    ...
    var data = [{ data: d1, label: "Pressure", color: "#3eacff" }];

    var markings = [
        { color: "#313942", yaxis: { from: 1 } },
        { color: "#313942", yaxis: { to: -1 } },
        { color: "#3eacff", lineWidth: 1, xaxis: { from: 2, to: 2 } },
        { color: "#3eacff", lineWidth: 1, xaxis: { from: 8, to: 8 } }
    ];
